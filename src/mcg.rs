// Chapter 24: Multi-purpose Clock Generator (MCG)
// Goal is to set the MCG to PEE mode to be stable for the serial
// port debugging
...
// MCG mode: Frequency-locked loop Engaged Internal (FEI)
// the processor starts in this mode
pub struct Fei {
    mcg: &'static mut Mcg
}

// MCG mode: Frequency-locked loop Bypassed External (FBE)
pub struct Fbe {
    mcg: &'static mut Mcg
}

// MCG mode: Phase-locked loop Bypassed External (PBE)
pub struct Pbe {
    mcg: &'static mut Mcg
}
